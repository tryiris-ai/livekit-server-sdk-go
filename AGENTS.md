# AGENTS.md — livekit-server-sdk-go
...
~/iris/ai.knowledge/rules/livekit-server-sdk-go/INDEX.md  (if exists)
~/iris/ai.knowledge/knowledge/global/INDEX.md
~/iris/ai.knowledge/knowledge/livekit-server-sdk-go/INDEX.md  (if exists)
```
...
Agent mistake → `/iris-rule global|livekit-server-sdk-go {rule}`
Explained something new → `/iris-learn global|livekit-server-sdk-go {context}`
